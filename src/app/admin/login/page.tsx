...
export default function AdminLogin() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-[var(--bg-soft)]">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-bold text-[var(--text)]">
            <span className="font-bold">Grana</span><span className="font-light text-[var(--text-secondary)]">3D</span>
          </h1>
          <p className="text-[var(--text-muted)] text-sm mt-1">Panel de administración</p>
        </div>
        ...
        <div className="bg-white border border-[var(--border)] rounded-2xl p-6 shadow-sm">
          <button
            ...
            disabled={signingIn}
            className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl border border-[var(--border)] hover:bg-[var(--bg-soft)] hover:border-[var(--border-hover)] transition-all text-sm font-medium text-[var(--text)] disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {signingIn ? (
          ...
          {error && (
            <div className="mt-4 flex items-center gap-2 px-3 py-2.5 rounded-xl bg-[var(--danger-soft)]">
