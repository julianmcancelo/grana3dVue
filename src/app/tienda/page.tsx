        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-3">
              <a href="/tracking" className="text-sm text-[var(--text-muted)] hover:text-[var(--accent)] transition-colors">
                Tracking
              </a>
...
function HomeContent() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      {/* Hero */}
      <section className={`relative overflow-hidden bg-[var(--bg-soft)] transition-all duration-700 ${visible ? 'opacity-100' : 'opacity-0'}`}>
        ...
        <div className="relative max-w-5xl mx-auto px-6 py-20 sm:py-28 text-center">
          <img src="/logo-grana3d.png" alt="Grana 3D" className="h-12 w-auto mx-auto mb-6"/>
          ...
          <a
            href="#productos"
            className="mt-8 inline-flex items-center gap-2 px-8 py-3.5 rounded-full bg-[var(--text)] text-white font-medium text-sm hover:bg-[var(--accent)] transition-colors duration-200"
          >
            Ver productos
      ...
      {/* Products */}
      <main id="productos" className="max-w-5xl mx-auto px-6 py-16 sm:py-20 flex-1">
